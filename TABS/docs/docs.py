...
If you want, I can:
- Generate a more structured developer reference (table of functions / classes and their method signatures), or
- Produce a separate “secure review checklist” that highlights exactly which files and functions to audit before running builds.

---
Generated by local repository inspection on the developer machine. This document intentionally focuses on design, configuration, and code structure (non-actionable descriptions only).
"""
